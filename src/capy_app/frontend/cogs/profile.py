...
class Profile(commands.Cog):
    ...
    async def create(self, ctx):
        ...
        """
        if self.lock.locked():
            await ctx.send("Only one command can be run at a time.")
            return
        
        
        # Send the welcome message to the user
        with self.lock: # Lock the command to prevent multiple users from running it at the same time
        ...
        self.logger.info(f"Lock is released and Profile is complete")
    ...
    async def update(self, ctx):
        ...
        self.logger.info("Lock is released and finished updating user profile.")
    ...
    async def show_profile(self, ctx):
        ...
        self.logger.info("Lock is released and finished showing user profile.")
